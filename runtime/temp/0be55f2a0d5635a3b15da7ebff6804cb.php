<?php /*a:2:{s:80:"D:\webroot\semclientcmsv3.1\application\admin\view\sem\keyword_category\add.html";i:1591257505;s:62:"D:\webroot\semclientcmsv3.1\application\admin\view\layout.html";i:1584695012;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8"/>
...
layui.use(['layer', 'form', 'admin', 'element', 'laydate', 'fileChoose'], function () {
    ...
    form.on('submit(categoryEditSubmit)', function (data) {
        console.log(data);
        var loadIndex = layer.load(2);
        $.post('<?php echo url("admin/sem.keyword_category/add"); ?>', data.field, function (res) {
            console.log(res);
            layer.close(loadIndex);
            if (res.status == '1') {
                layer.msg(res.msg, {icon: 1,time:1000}, function(){
