<?php /*a:1:{s:75:"D:\webroot\semclientcmsv3.1\application\admin\view\index\tpllockscreen.html";i:1584436620;}*/ ?>
<div class="lock-screen-wrapper">
    <div class="lock-screen-time"></div>
    <div class="lock-screen-date"></div>
    <div class="lock-screen-form">
        <input placeholder="请输入解锁密码" class="lock-screen-psw" maxlength="20" type="password"/>
